    ...
    if(aux){
        ...
        switch (aux->tipo){
            ...
            case LESS_EQUAL:
                ...
                imprimirLessEqual(p->text,auxReg2.tipo,auxReg2.num,auxReg.tipo,auxReg.num,c.tipo,c.num);
                break;
            case LESS_THAN:
                auxReg = imprimeExpressao(p,aux->filho_direito);
                auxReg2 = imprimeExpressao(p,aux->filho_esquerdo);
            ...
            case MULTIPLY:
                ...
                inseriMul(p->text,auxReg2.tipo,auxReg2.num,auxReg.tipo,auxReg.num,c.tipo,c.num);
                break;
            // case DIV:
            //     auxReg = imprimeExpressao(p,aux->filho_direito,reg+1);
            //     auxReg2 = imprimeExpressao(p,aux->filho_esquerdo,auxReg+1);
            ...
            case MINUS:
                ...
                inseriSub(p->text,auxReg.tipo,auxReg.num,auxReg2.tipo,auxReg2.num,c.tipo,c.num);
                break;
            case LOGICAL_AND:
                auxReg = imprimeExpressao(p,aux->filho_direito);
                auxReg2 = imprimeExpressao(p,aux->filho_esquerdo);
